export default function FilterSidebar({
  ...
  const label =
    "flex cursor-pointer items-center gap-2 py-1.5 text-sm text-slate-600";
  const subcategories = [
    ...new Set(categories.flatMap((category) => category.subcategories || [])),
  ];
  return (
    <aside className="h-max rounded-xl border border-slate-200 bg-white">
      <h3 className="rounded-t-xl bg-gradient-to-r from-[#651b89] to-[#932db3] px-5 py-4 font-bold text-white">
        ⚙　Filters
      </h3>
      <div className="grid gap-2 p-5">
        <b className="mt-1 text-sm">Category</b>
        ...
        <b className="mt-3 text-sm">Sub-category</b>
        ...
        <b className="mt-3 text-sm">Price Range</b>
        ...
        <b className="mt-3 text-sm">Availability</b>
        <label className={label}>
          <input
            className="accent-[#79259c]"
            type="checkbox"
        ...
        <b className="mt-3 text-sm">Rating</b>
        <label className={label}>
          <input
            className="accent-[#79259c]"
            type="radio"
        ...
        <button
          className="mt-3 rounded-md border border-[#79259c] py-2 text-sm font-bold text-[#79259c] hover:bg-[#faf4fc]"
          onClick={() => onChange?.({})}>
          ↻ Reset Filters
        </button>
      </div>
